...
save_location ="/net/thunder/data1/sp1016/FINESSE_LBLRTM/fir_simulation_wrapper/example_lbldis_output/FINESSE2/"
...
h_obs = pressure[0]  ## Pressure height of observation
...
if h_start_blackbody_surface==False:
    ...
    sfc_em = np.vstack([wn,np.full_like(wn,0.9)]) # It is setting it to 0.9
